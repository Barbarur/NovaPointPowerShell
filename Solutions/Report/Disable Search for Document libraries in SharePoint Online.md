...
function Find-List {
    ...
    Add-ScriptLog -Color White -Msg "Finding List '$($ListID)'"
    ...
    {
        Add-ReportRecord -SiteUrl $oSite.Url -ListID $ListID -ListTitle ""$List.Title"" -Remarks "Couldn't find this list"
    }
}
